...
public class LoadBalanceUtil {
	...
	private final static MyAtomicInteger myAtomicInteger = new MyAtomicInteger(-1); //轮询的原子计数器
	...
	public static LoadBalanceBean getPollingLoadBalanceConnPool(List<ConnectionPoolFactory> poolFactorys) {
		ConnectionPoolFactory selectPoolFactory = poolFactorys.get(myAtomicInteger.incrementAndGet(poolFactorys.size()));
		TProtocol tProtocol = selectPoolFactory.getConnection(); 
